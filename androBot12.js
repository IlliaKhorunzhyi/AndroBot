  ...
  window.addEventListener("load", function () {
    document.body.innerHTML += `
            ...
            #andro {
                ...
                z-index: 1;
                pointer-events: none;
                background: url(https://i.ibb.co/ZhJKk3t/placeholder.jpg);
            }
            #video_container{
                overflow:hidden;
                border-radius:50%;
            ...
            <div class="andro">
                ...
                <img id="placeholder" src="https://i.ibb.co/ZhJKk3t/placeholder.jpg">
                <div id="video_container">
                    <video id="andro" poster="https://i.ibb.co/ZhJKk3t/placeholder.jpg" src="${video_url}"></video>
                </div>
                <span id="menu">
                <div id="option1">${option_name_one}</div>
                    ...
                    <div id="options">
                    <div class="question">
                        Hello! Welcome to Aimient. Are you a candidate or an employer?
                    </div>
                </div>
            </div>`;
          ...
          if (event) {
            ...
            for (
              ...
              if (transcript.includes(option_name_one)) {
                ...
                transcript.includes("organization") ||
                transcript.includes("organisation")
              ) {
                if (!changed_opacity) {
                  changed_opacity = true;
                  placeholder.style.opacity = 1;
